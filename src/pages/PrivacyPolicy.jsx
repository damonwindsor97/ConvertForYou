    ...
    <div className="">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">Your privacy is important to us. This policy explains how ConvertForYou collects, uses, and protects your information when you use our conversion services.</p>
        </div>
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-12">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                <p className="text-white/90 leading-relaxed">We use Google Analytics to collect information such as Active Users, New Users, Active Users by Country, Views per Active User, and Average Engagement Time. This data helps us understand how our services are used and improve user experience. We do not share analytics data with any third parties beyond Google Analytics.</p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                  <p className="text-white/90 leading-relaxed mb-4">We store data both temporarily and permanently, depending on its use within the application.  Data is stored securely in our databases to enable our utilities and features to function. The types of data we store include:</p>
                    ...
                    <div className="bg-white/5 rounded-xl p-4 border border-blue-400/30">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">Links entered into our URL Shortener application, so our API can determine whether to create a new short URL or retrieve an existing one.</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-xl p-4 border border-red-400/30">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">Videos submitted for conversion are stored only briefly for processing and are deleted immediately after conversion is complete.</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-xl p-4 border border-yellow-400/30">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">We use cookies to track user history and limit usage to prevent abuse. Cookies and related data are stored temporarily and expire exactly 7 days after your first visit.</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-xl p-4 border border-green-400/30">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/80 text-sm">Image files are processed entirely in your browser using client-side technology. No image data is sent to our servers, ensuring complete privacy.
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="mb-12">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                <p className="text-white/90 leading-relaxed">If you wish to access, correct, or request deletion of your data, please contact us at{' '}<a href="mailto:support@convertforyou.com" className="text-purple-300 hover:text-purple-200 underline decoration-purple-300/50 hover:decoration-purple-200 transition-colors"></a>. We will respond to your request as soon as possible.</p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                <p className="text-white/90 leading-relaxed">We take reasonable measures to protect your data from unauthorized access, disclosure, or loss. However, no method of transmission over the Internet or electronic storage is 100% secure.</p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                <p className="text-white/90 leading-relaxed">We may update this privacy policy from time to time. Any changes will be posted on this page with an updated revision date.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 border-t border-white/10 p-8">
            <div className="text-center space-y-4">
              ...
              <div className="bg-white/5 rounded-xl p-4 border border-white/10 max-w-2xl mx-auto">
                ...
                <p className="text-white/80 text-sm">If you have any questions or concerns about this privacy policy or your data, please contact us at{' '}<a href="mailto:support@convertforyou.com" className="text-blue-300 hover:text-blue-200 underline decoration-blue-300/50 hover:decoration-blue-200 transition-colors">support@convertforyou.com</a>
                </p>
              </div>
            </div>
          </div>
