          ...
          <div className="flex flex-col space-y-6 max-w-md">
            <div>
              ...
              <p className="text-white/50 text-sm leading-relaxed">
                Transform your files instantly with our secure, fast, and completely free conversion tools. No registration required.
              </p>
            </div>
            
            {/* Buy Me a Coffee */}
            <Link 
              to="https://www.buymeacoffee.com/sweg" 
              className="group inline-flex items-center space-x-3 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-400 hover:to-orange-400 text-black font-bold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl w-fit"
            >
          ...
          <div className="flex flex-col lg:flex-row space-y-8 lg:space-y-0 lg:space-x-16">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link 
                    to="/status" 
                    className="group flex items-center space-x-3 text-white/70 hover:text-white transition-all duration-300 hover:translate-x-1"
                  >
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <div className="group flex items-center space-x-3 text-white/70">
                    <BiSupport className="w-4 h-4 text-pink-400" />
